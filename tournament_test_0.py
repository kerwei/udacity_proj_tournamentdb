...
def testReportMatches():
    ...
    reportMatch(id1, id2)
    reportMatch(id3, id4)
    checks = playerStandings()
    standings = playerStandings()
    for (i, n, w, m) in standings:
        print('%s, %s, %s, %s' % (i, n, w, m))
        if m != 1:
...
def testPairings():
    ...
    pairings = swissPairings(playerStandings())
    ...
    print("Actual: {}".format(str(actual_pairs)))
    print("Possible: {}".format(str(possible_pairs)))
